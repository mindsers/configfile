...
const { ConfigurationFileNotExist } = require('../services/config/config-file-not-exist.error')
const { ScriptNotExist } = require('../services/file/script-not-exist.error')
const { BadScriptPermission } = require('../services/file/bad-script-permission.error')
